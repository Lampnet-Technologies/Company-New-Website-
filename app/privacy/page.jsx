      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            LampNet Solutions ("we," "our," or "us") is committed to protecting your privacy. 
            This Privacy Policy explains how we collect, use, disclose, and safeguard your 
            information when you use our services. We comply with applicable data protection laws 
            across Africa, including the Nigeria Data Protection Regulation (NDPR) and other 
            relevant African data protection frameworks.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.subsection}>
            <h3 className={styles.subsectionTitle}>Project-Related Information:</h3>
            <ul className={styles.list}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>Communicating with you about projects, services, and support</li>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li>
              <strong>Service Providers:</strong> Trusted third parties who assist in service 
              delivery (cloud hosting, payment processors, analytics)
            </li>
            <li>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            ...
            encryption, secure servers, access controls, and regular security assessments. However, 
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            ...
            Project-related data is typically retained for 7 years after project completion, or as 
            required by law.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              <strong>Lodge Complaints:</strong> File complaints with data protection authorities
            </li>
          </ul>
          <p className={styles.text}>
            To exercise these rights, contact us at{' '}
            <a href="mailto:privacy@lampnet.com" className={styles.link}>privacy@lampnet.com</a>
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            As we serve clients across Africa, your information may be transferred to and processed 
            in different African countries. We ensure appropriate safeguards are in place for such 
        ...
        <section className={styles.section}>
          ...
          <div className={styles.contactBox}>
            <p>Email: <a href="mailto:privacy@lampnet.com" className={styles.link}>privacy@lampnet.com</a></p>
